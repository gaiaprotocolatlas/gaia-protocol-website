...
export default class Partnerships extends DomNode {
    ...
    constructor(lang) {
        ...
        this.append(el("h1", "Partnerships"), this.partnershipList = el(".partnership-list"));
        for (const partner of this.partners) {
            this.partnershipList.append(new Card({}, el("a", el("img", { src: partner.logo }), el("main", el("h2", partner.name)), { href: partner.link, target: "_blank" })));
        }
    }
}
